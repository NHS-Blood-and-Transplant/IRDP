...
{
    [EntityLogicalNameAttribute("importentitymapping")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    [DataContract(Name = "Entity", Namespace = "http://schemas.microsoft.com/xrm/2011/Contracts")]
    public partial class ImportEntityMapping : BaseProxyClass
    {
        public new const string LogicalName = "importentitymapping";
        public const int ObjectTypeCode = 4428;
        public const string PrimaryIdAttribute = "importentitymappingid";
        public const string PrimaryNameAttribute = "";
        
        static ImportEntityMapping()
        {
            BaseProxyClass.RegisterProxyType(typeof(ImportEntityMapping), "importentitymapping");
        ...
        public ImportEntityMapping() : base(new Entity("importentitymapping")) { }
        public ImportEntityMapping(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<ImportEntityMapping>(); }
        /// <summary>
...
///<para>Logical Name: importentitymappingid</para>
///</summary>
[AttributeLogicalNameAttribute("importentitymappingid")]
public Guid ImportEntityMappingId
{
	...
	{
		base.Id = value;
		base.SetPropertyValue("importentitymappingid", value, "ImportEntityMappingId");
	}
}
///<summary>
...
///<summary>
///<para>Logical Name: importentitymappingidunique</para>
///</summary>
[AttributeLogicalNameAttribute("importentitymappingidunique")]
public Guid ImportEntityMappingIdUnique
{
	get { return this.GetPropertyValue<Guid>("importentitymappingidunique"); }
}
///<summary>
...
///Logical Name: dedupe
/// </summary>
[AttributeLogicalNameAttribute("dedupe")]
public eDetectDuplicates? RemoveDuplicates
{
	get
	{
		if (RemoveDuplicates_OptionSetValue != null) { return (eDetectDuplicates)RemoveDuplicates_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.RemoveDuplicates_OptionSetValue = new OptionSetValue((int)value); }
		else this.RemoveDuplicates_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: dedupe</para>
///</summary>
[AttributeLogicalNameAttribute("dedupe")]
public OptionSetValue RemoveDuplicates_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("dedupe"); }
	set { this.SetPropertyValue<OptionSetValue>("dedupe", value, "RemoveDuplicates_OptionSetValue"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string RemoveDuplicates_Text(IOrganizationService Service)
{
	return this.RemoveDuplicates_OptionSetValue.GetOptionSetText(Service, this, "dedupe");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <para>Schema Name: userentityinstancedata_importentitymapping</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>importentitymappingid</para>
	/// <para>importentitymappingid</para></summary>
	...
	/// <summary><para>importentitymappingidunique</para>
	/// <para>importentitymappingidunique</para></summary>
	...
	/// <summary><para>Remove Duplicates</para>
	/// <para>dedupe</para></summary>
